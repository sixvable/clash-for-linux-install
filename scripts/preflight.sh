...
_download_zip() {
    ...
    x86_64)
        ...
        url_clash=https://github.com/sixvable/clash-for-linux-install/releases/download/clash/clash-linux-amd64-2023.08.17.gz
        ...
        ;;
    *86*)
        url_clash=https://github.com/sixvable/clash-for-linux-install/releases/download/clash/clash-linux-386-2023.08.17.gz
        ...
        ;;
    armv*)
        url_clash=https://github.com/sixvable/clash-for-linux-install/releases/download/clash/clash-linux-armv5-2023.08.17.gz
        ...
        ;;
    aarch64)
        url_clash=https://github.com/sixvable/clash-for-linux-install/releases/download/clash/clash-linux-arm64-2023.08.17.gz
